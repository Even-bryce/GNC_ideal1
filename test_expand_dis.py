...
def evaluate_step_length(args):
    ...
    """
    step_length, env_map, waypoints, r_crash, r_risk, n_tests, planner_type = args
...
if __name__ == '__main__':
    ...
    for step, succ, it, ti, le in results:
        ...
        if it is not None:
            ...
            print(f"步长 {step:3d} | 成功: 0/{num_of_tests} | 失败")
    ...
    plt.suptitle(f'Step Length Sweep — {planner_type}')
    plt.tight_layout()

    save_path = os.path.join(save_dir, f'test_step_length_{planner_type}.png')
