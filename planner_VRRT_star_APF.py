...
class VRRT_star_APF:
    def __init__(self, env_map, waypoints, R_crash, R_risk, obstacle_list, expand_dis=25, max_iter=1500, search_radius=110, search_until_max_iter=False):
        ...
        :param obstacle_list: 障碍物列表，每个障碍物 [x, y, zmin, zmax, R_ob_crash, R_ob_risk]
    ...
    def planning(self):
        ...
        for i in range(self.max_iter):  # 循环执行最大迭代次数
            ...
            # 计算扩展方向并生成新节点
            new_nodes_list = self.apf_steer(nearest_nodes_list, random_nodes_array, goal_nodes_list)
