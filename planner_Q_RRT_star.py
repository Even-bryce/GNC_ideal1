...
class RRTStar:
    def __init__(self, start, goal, R_crash, R_risk, obstacle_list, rand_area, expand_dis=25, max_iter=1500, search_radius=20.0, N_layers = 3, search_until_max_iter=True):
        """
        初始化 RRT* 算法的参数
